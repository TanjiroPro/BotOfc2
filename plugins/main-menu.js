...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
  try {
    ...
    await conn.sendMessage(m.chat, {
      ...
      footer: '💖 ʙᴜɴɴʏ ʙᴏᴛ 💖',
      buttons: [
        { buttonId: `${_p}owner`, buttonText: { displayText: 'ᴄʀᴇᴀᴅᴏʀ 💖' }, type: 1 },
        { buttonId: `${_p}grupos`, buttonText: { displayText: 'ɢʀᴜᴘᴏ 💖' }, type: 1 },
        { buttonId: `${_p}comprarbot`, buttonText: { displayText: 'ᴄᴏᴍᴘʀᴀʀ ʙᴏᴛ 💖' }, type: 1 }
      ],
      viewOnce: true
    }, { quoted: m })
